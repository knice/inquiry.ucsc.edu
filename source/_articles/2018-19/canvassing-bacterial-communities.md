...
<figure class="" style="width:600px;">
  {% img 2018/in-vivo-intestinal-v-cholerae.jpg magick:resize:600 alt:'Confocal microscopy images of V. cholerae' %}<figcaption>Scanning electron (left) and fluorescence (right) micrographs of in vivo intestinal <span style="font-style:italic; font-weight:bold">V. cholerae</span> biofilms. In the image on the right, epithelial cells—those that line the gut—are blue and the bacteria are green.</figcaption>
</figure>
