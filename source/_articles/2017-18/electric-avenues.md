...
Caption: ABOVE: (A and B) Skates and sharks locate their prey by detecting the weak electric fields naturally generated by biomechanical activity. (C) A network of electrosensory organs called the ampullae of Lorenzini is responsible for this sense. (D) An individual ampulla consists of a surface pore connected to a set of electrosensory cells by a long jelly-filled canal. Sharks and skates can sense fields as small as 5 nV/cm.

images: skates by luk cox

Caption: BELOW: Small sample of a foam blank that is being tested for properties that may make surfboards more ecologically sustainable.

Caption: ABOVE: Pressing along the canals on the ventral side of an adult skate causes jelly to extrude from the pores of the ampullae of Lorenzini.

pHotos: foam block by john felts; &quot;shark snot&quot; by erik josberger; dna sequencer courtesy Oxford Nanopore å